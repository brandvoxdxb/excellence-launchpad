        ...
        {quarters.map((quarter, index) => (
          ...
          >
            ...
            <div className={`hidden lg:block absolute top-6 ${
              ...
              <div className={`w-3.5 h-3.5 rounded-full bg-gradient-to-br ${quarterColors[index]}`} />
            </div>

            <div className="p-6 rounded-2xl bg-card border border-border/50 hover:border-primary/20 transition-colors">
              <div className={`inline-block px-3 py-1 rounded-full bg-gradient-to-r ${quarterColors[index]} text-xs font-bold text-white mb-4`}>
                {quarter.name}
              </div>
